...
layout = [[sg.Text('                                        AGROTECH', font=("Times New Roman", 30), text_color='white',background_color='black')],
          # Defining the layout of the Graphical User Interface. It consist of some text, Buttons, and blanks to take Input.
          [sg.Text('Please enter the following details :-', font=("Helvetica", 20),text_color='white',background_color='black')],
          # We have defined the text size, font type, font size, blank size, colour of the text in the GUI.
          [sg.Text('Enter ratio of Nitrogen in the soil                                  :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1))],
          [sg.Text('Enter ratio of Phosphorous in the soil                           :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1))],
          [sg.Text('Enter ratio of Potassium in the soil                               :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1))],
          [sg.Text('Enter average Temperature value around the field        :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1)), sg.Text('*C', font=("Helvetica", 20),text_color='white',background_color='black')],
          [sg.Text('Enter average percentage of Humidity around the field :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1)), sg.Text('%', font=("Helvetica", 20),text_color='white',background_color='black')],
          [sg.Text('Enter PH value of the soil                                            :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1))],
          [sg.Text('Enter average amount of Rainfall around the field        :', font=("Helvetica", 20),text_color='white',background_color='black'),
           sg.Input(font=("Helvetica", 20), size=(20, 1)), sg.Text('mm', font=("Helvetica", 20),text_color='white',background_color='black')],
          [sg.Text(size=(50, 1), font=("Helvetica", 25), text_color='white',background_color='black', key='-OUTPUT1-')],
          [sg.Button('Submit', font=("Helvetica", 20)), sg.Button('Quit', font=("Helvetica", 20),)]]
window = sg.Window('AGROTECH', layout,background_color="black")
...
while True:
    ...
    if predict1 == 0:  # Above we have converted the crop names into numerical form, so that we can apply the machine learning model easily. Now we have to again change the numerical values into names of crop so that we can print it when required.
        crop_name = 'Apple(ஆப்பிள்)'
    elif predict1 == 1:
        crop_name = 'Banana(வாழைப்பழம்)'
    elif predict1 == 2:
        crop_name = 'Blackgram(உளுந்து)'
    elif predict1 == 3:
        crop_name = 'Chickpea(கொண்டைக்கடலை)'
    elif predict1 == 4:
        crop_name = 'Coconut(தேங்காய்)'
    elif predict1 == 5:
        crop_name = 'Coffee(கொட்டைவடி நீர்)'
    elif predict1 == 6:
       crop_name = 'Cotton(பருத்தி)'
    elif predict1 == 7:
       crop_name = 'Grapes(திராட்சை)'
    elif predict1 == 8:
       crop_name = 'Jute(சணல்)'
    elif predict1 == 9:
       crop_name = 'Kidneybeans(சிவப்பு காராமணி)'
    elif predict1 == 10:
       crop_name = 'Lentil(பருப்பு)'
    elif predict1 == 11:
       crop_name = 'Maize(சோளம்)'
    elif predict1 == 12:
       crop_name = 'Mango(மாங்கனி)'
    elif predict1 == 13:
       crop_name = 'Mothbeans(தட்டை பயறு)'
    elif predict1 == 14:
       crop_name = 'Mungbeans(பாசிப்பயறு)'
    elif predict1 == 15:
        crop_name = 'Muskmelon(முலாம்பழம்)'
    elif predict1 == 16:
        crop_name = 'Orange(ஆரஞ்சு)'
    elif predict1 == 17:
         crop_name = 'Papaya(பப்பாளி)'
    elif predict1 == 18:
        crop_name = 'Pigeonpeas(துவரை விதை)'
    elif predict1 == 19:
       crop_name = 'Pomegranate(மாதுளை)'
    elif predict1 == 20:
       crop_name = 'Rice(அரிசி)'
    elif predict1 == 21:
        crop_name = 'Watermelon(தர்பூசணி)'
